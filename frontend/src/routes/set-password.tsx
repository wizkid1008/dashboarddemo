...
export function SetPasswordPage() {
  const { session, needsPasswordSet, clearNeedsPasswordSet } = useAuth()
  ...
  useEffect(() => {
    if (success && !needsPasswordSet) void navigate({ to: '/' })
  }, [success, needsPasswordSet, navigate])
  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="login-subtitle">Choose a password to complete your account setup.</p>
